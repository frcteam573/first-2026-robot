...
class TunerConstants:
    ...
    canbus = CANBus("573CANivore", "./logs/example.hoot")

    # Theoretical free speed (m/s) at 12 V applied output;
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 5.47

    # Every 1 rotation of the azimuth results in _couple_ratio drive motor turns;
    # This may need to be tuned to your individual robot
    _couple_ratio = 0

    _drive_gear_ratio = 4.9411764705882355
    _steer_gear_ratio = 25.9
    _wheel_radius: units.meter = inchesToMeters(1.75)
    ...
    # Front Left
    _front_left_drive_motor_id = 8
    _front_left_steer_motor_id = 7
    _front_left_encoder_id = 12
    _front_left_encoder_offset: units.rotation = 0.3349609375
    _front_left_steer_motor_inverted = False
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(10.0625)
    _front_left_y_pos: units.meter = inchesToMeters(13.375)

    # Front Right
    _front_right_drive_motor_id = 2
    _front_right_steer_motor_id = 1
    _front_right_encoder_id = 9
    _front_right_encoder_offset: units.rotation = 0.332763671875
    _front_right_steer_motor_inverted = False
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(10.0625)
    _front_right_y_pos: units.meter = inchesToMeters(-13.375)

    # Back Left
    _back_left_drive_motor_id = 6
    _back_left_steer_motor_id = 5
    _back_left_encoder_id = 11
    _back_left_encoder_offset: units.rotation = 0.170166015625
    _back_left_steer_motor_inverted = False
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-10.0625)
    _back_left_y_pos: units.meter = inchesToMeters(13.375)

    # Back Right
    _back_right_drive_motor_id = 4
    _back_right_steer_motor_id = 3
    _back_right_encoder_id = 10
    _back_right_encoder_offset: units.rotation = -0.040283203125
    _back_right_steer_motor_inverted = False
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-10.0625)
    _back_right_y_pos: units.meter = inchesToMeters(-13.375)
